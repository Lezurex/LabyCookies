<template>
  ...
  <p>Du hast einen Fehler gefunden, hast Ideen oder Fragen? Dann melde dich<br>entweder über Discord (Lezurex#4269) &
    (VoxCrafter_LP#4269) oder <a href="https://github.com/Lezurex/LabyCookies/issues/new">erstelle ein Issue</a>.</p>
