<template>
  <div class="overview-container">
    <span
        v-if="players.length === 0">Entweder sind keine Spieler in der Runde, oder du befindest dich auf der Lobby.</span>
    <div v-for="player in players" class="overview-card" :key="player.playerName" :class="player.calcCardColor()">
